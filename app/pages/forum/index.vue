  ...
  <div class="min-h-screen bg-paper">
    ...
    <div class="relative bg-gradient-to-r from-gold-600 via-gold-500 to-cyan-600 text-white py-16 px-4 overflow-hidden">
      ...
      <div class="absolute top-0 left-0 w-full h-full opacity-10">
        <div class="absolute top-4 left-8 text-8xl">
          🏛️
        </div>
        <div class="absolute bottom-4 right-8 text-8xl">
          🏯
        </div>
        <div class="absolute top-1/2 left-1/4 text-6xl">
          🔔
        </div>
      </div>
      ...
      <div class="max-w-7xl mx-auto relative z-10">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p class="text-gold-100 text-lg md:text-xl">
              与志同道合的朋友分享古建筑之美
            </p>
          </div>
          <div class="flex items-center gap-6">
            <div class="text-center bg-white/10 backdrop-blur-sm rounded-2xl px-6 py-4">
              ...
              <div class="text-sm text-gold-100">
                帖子数
              </div>
            </div>
            <div class="text-center bg-white/10 backdrop-blur-sm rounded-2xl px-6 py-4">
            ...
            <div class="flex items-center justify-between mt-4">
              ...
              <div class="flex items-center gap-3">
                ...
                >
                  ...
                  <option
                    v-for="cat in categoriesForPost"
                    :key="cat"
                    :value="cat"
                  >
                    {{ cat }}
                ...
                >
                  ...
                  >
                    <path
                      ...
                      stroke-linejoin="round"
                      stroke-width="2"
                      d="M12 19v-7m0 0l-3 3m3-3l3 3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"
                    />
                  </svg>
                  <span>发布帖子</span>
                </button>
      ...
      <div class="flex gap-6">
        ...
        <div class="flex-1">
          ...
          <div class="bg-white rounded-2xl shadow-ancient p-4 border border-gold-100 mb-6">
            <div class="flex flex-wrap items-center gap-4">
              ...
              <div class="relative">
                ...
                <svg
                  class="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-ink-light pointer-events-none"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div class="space-y-5">
            ...
            >
              ...
              <div class="px-6 py-4 border-b border-gold-100 flex items-center justify-between">
                <div class="flex items-center gap-3">
                  <div class="relative">
                    ...
                    >
                    <span class="absolute -bottom-0.5 -right-0.5 w-4 h-4 bg-gold-500 rounded-full border-2 border-white" />
                  </div>
                  <div>
                    <h4 class="font-semibold text-ink-black text-base">
                      {{ post.userName }}
                    </h4>
              ...
              <!-- 帖子内容 -->
              <div class="px-6 py-5">
                <h3 class="text-xl font-bold text-ink-black mb-3 line-clamp-2 group-hover:text-gold-700 transition-colors">
                  {{ post.title }}
                </h3>
                <p class="text-ink-medium text-sm leading-relaxed mb-4 line-clamp-3">
                  {{ post.content }}
                </p>
                ...
                <div
                  v-if="post.image"
                  class="mb-4 rounded-xl overflow-hidden group-hover:shadow-lg transition-shadow"
                >
                  <img
                    :src="post.image"
                ...
                <!-- 关联古建筑 -->
                <div
                  v-if="post.buildingName"
                  class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-50 to-cyan-100 rounded-xl cursor-pointer hover:from-cyan-100 hover:to-cyan-200 transition-all"
                >
                  <svg
              ...
              <div class="px-6 py-4 bg-gradient-to-r from-gold-50/80 to-transparent flex items-center justify-between">
                <div class="flex items-center gap-6">
                  ...
                  >
                    <svg
                      class="w-6 h-6 transition-transform group-hover/item:scale-110"
                  ...
                  <button
                    class="flex items-center gap-2 text-ink-medium hover:text-gold-700 transition-all"
                  ...
                  <button
                    class="flex items-center gap-2 text-ink-medium hover:text-cyan-600 transition-all"
                ...
                <button class="flex items-center gap-2 text-ink-medium hover:text-gold-700 transition-all opacity-0 group-hover:opacity-100">
                  ...
                  >
                    <path
                      ...
                      stroke-linejoin="round"
                      stroke-width="2"
                      d="M5 8h14M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"
                    />
                  </svg>
        ...
        <div class="hidden lg:block w-80 flex-shrink-0 space-y-6">
          ...
          <div class="bg-white rounded-3xl shadow-ancient p-6 border-2 border-gold-100 relative overflow-hidden">
            <!-- 古风装饰 -->
            <div class="absolute -top-2 -left-2 text-6xl opacity-5">
              🎭
            </div>
            <div class="flex items-center justify-between mb-6 relative z-10">
              ...
              <button
                class="text-sm text-gold-700 hover:text-gold-800 font-medium flex items-center gap-1 hover:bg-gold-50 px-3 py-1.5 rounded-xl transition-all"
            ...
            <div class="space-y-4 relative z-10">
              ...
              >
                <div class="relative">
                  ...
                  >
                  <span :class="['absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-3 border-white', user.online ? 'bg-emerald-500 animate-pulse' : 'bg-gray-300']" />
                </div>
                <div class="flex-1 min-w-0">
                  <div class="flex items-center justify-between">
                    <h4 class="font-semibold text-ink-black text-base truncate">
                      {{ user.name }}
                    </h4>
          ...
          <div class="bg-white rounded-3xl shadow-ancient p-6 border-2 border-gold-100 relative overflow-hidden">
            <!-- 古风装饰 -->
            <div class="absolute -bottom-2 -right-2 text-6xl opacity-5">
              🔥
            </div>
            ...
            <div class="space-y-4 relative z-10">
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  <h4 class="text-base text-ink-black font-semibold truncate group-hover:text-gold-700 transition-colors">
                    {{ topic.name }}
                  </h4>
                    ...
                    <div :class="['flex items-center gap-1 text-xs font-medium', topic.trend === 'up' ? 'text-emerald-600' : topic.trend === 'down' ? 'text-vermilion-600' : 'text-gray-400']">
                      ...
                      >
                        <path
                          ...
                          stroke-linejoin="round"
                          stroke-width="2"
                          d="M7 16h4m4 0h4m-8-4v4m0 8H7a2 2 0 01-2-2V6a2 2 0 012-2h4a2 2 0 012 2v4m-4 8h4m-4 0l4-4m0 0l4 4m-4-4v4"
                        />
                      </svg>
          ...
          <div class="bg-white rounded-3xl shadow-ancient p-6 border-2 border-gold-100 relative overflow-hidden">
            <!-- 古风装饰 -->
            <div class="absolute -top-4 -right-4 text-7xl opacity-5">
              💬
            </div>
            ...
            <div class="flex flex-wrap gap-3 relative z-10">
              ...
              >
                ...
                >
                <span class="absolute -bottom-1 -right-1 w-4 h-4 bg-emerald-500 rounded-full border-3 border-white animate-pulse" />
                <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-gradient-to-r from-gold-600 to-gold-700 text-white text-xs font-medium rounded-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10 shadow-xl">
                  {{ user.name }}
                  <div class="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gold-600" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gradient-to-br from-gold-500 via-gold-600 to-gold-700 rounded-3xl shadow-xl p-6 text-white relative overflow-hidden">
            <!-- 古风装饰 -->
            <div class="absolute -top-6 -left-6 text-8xl opacity-10">
              🏛️
            </div>
            <div class="text-5xl mb-4 text-center relative z-10">
              🏛️
            </div>
            <h3 class="font-bold text-xl mb-3 text-center relative z-10">
              今日精选
            </h3>
            <p class="text-sm text-gold-100 text-center mb-5 relative z-10">
              探索中国古建筑的无限魅力
            </p>
            <div class="grid grid-cols-2 gap-3">
              <div class="bg-white/10 rounded-xl p-3 text-center">
                ...
                <div class="text-xs text-gold-100">
                  今日帖子
                </div>
              </div>
              <div class="bg-white/10 rounded-xl p-3 text-center">
    ...
    >
      <div
        class="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden shadow-2xl animate-fade-in"
        @click.stop
      >
        <!-- 弹窗头部 -->
        <div class="px-6 py-4 border-b border-gold-100 flex items-center justify-between bg-gradient-to-r from-gold-50 to-transparent">
          <h3 class="text-lg font-bold text-ink-black">
            帖子详情
          </h3>
          <div class="flex items-center gap-2">
            <button class="p-2 hover:bg-gold-100 rounded-lg transition-colors">
              <svg
                class="w-5 h-5 text-ink-medium"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <button
              class="p-2 hover:bg-gold-100 rounded-lg transition-colors"
              @click="closePost"
            >
              <svg
                class="w-5 h-5 text-ink-medium"
        ...
        <div class="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
          ...
          <div class="flex items-start gap-4 mb-6">
            <img
              ...
              class="w-12 h-12 rounded-full object-cover border-2 border-gold-200"
            >
            <div class="flex-1">
              <div class="flex items-center gap-2">
                <h4 class="font-bold text-ink-black">
          ...
          <h2 class="text-xl font-bold text-ink-black mb-4">
            {{ selectedPost.title }}
          </h2>
          <p class="text-ink-medium leading-relaxed mb-4 whitespace-pre-wrap">
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="flex-1">
                        ...
                        <p class="text-ink-medium text-xs">
                          {{ reply.content }}
                        </p>
                      </div>
                    </div>
